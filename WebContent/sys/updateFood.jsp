...
<div id="TitleArea">
	...
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">
					...
					<img border="0" width="13" height="13" src="${pageContext.request.contextPath}/sys/public/style/images/title_arrow.gif"/> 更新新菜品
...
<div id="MainArea">
	...
	<form action="#" method="post" enctype="multipart/form-data">
		...
		<div class="ItemBlock_Title">
        	<img width="4" height="7" border="0" src="${pageContext.request.contextPath}/sys/public/style/images/item_point.gif"> 菜品信息&nbsp;
        </div>
		<!-- 本段表单字段 -->
